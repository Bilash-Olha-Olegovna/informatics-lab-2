...
<div style="background-color: rgba(220, 53, 69, 0.1); border-left: 6px solid #dc3545; padding: 20px; margin: 30px 0; border-radius: 8px;">
  <div style="display: flex; align-items: center; margin-bottom: 15px;">
    <span style="font-size: 24px; margin-right: 15px;">🛑</span>
    <h3 style="margin: 0; color: #dc3545;">Кейс 1: "Небезпечна довіра"</h3>
  </div>
...
<details style="background: var(--bg-main); padding: 15px; border-radius: 8px; border: 1px solid var(--card-border); margin-top: 15px; cursor: pointer;">
...
<div style="background-color: rgba(23, 162, 184, 0.1); border-left: 6px solid #17a2b8; padding: 20px; margin: 30px 0; border-radius: 8px;">
  <div style="display: flex; align-items: center; margin-bottom: 15px;">
    <span style="font-size: 24px; margin-right: 15px;">🎨</span>
    <h3 style="margin: 0; color: #0c5460;">Кейс 2: "Чиє це мистецтво?"</h3>
  </div>
