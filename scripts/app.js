...
(() => {
    ...
    class PromptEngine {
        static eval() {
            ...
            const criteria = [
                { reg: /(уяви|дій|ти|ролі|експерт|вчитель)/i, msg: '🎭 Роль' },
                { reg: /(для|контекст|ситуація|учня|тому що)/i, msg: '🌍 Контекст' },
                { reg: /(напиши|створи|поясни|зроби|склади)/i, msg: '🎯 Завдання' },
